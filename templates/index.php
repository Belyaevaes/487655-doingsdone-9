                ...
                <table class="tasks">
                    ...
                    <?php foreach ($tasks as $key =>  $item): ?>
                        <?php if (($item['completed'] === 0) || ($showCompleteTasks === 1)): ?>
                            <tr class="tasks__item task <?php if ($item['completed'] === 1): ?>task--completed<?endif; ?> <?php  if ((checkExpirationDate($item['date']) === true) && ($item['date']) !== 'Нет'): ?>task--important<?php endif; ?>">
                                <td class="task__select">
